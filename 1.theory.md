...
This equation is initially quite complicated: 
  ...
  - depending on $f(u)$, $g(u)$ and $h(u)$ the equation may be non-linear in $u(t,x)$ and $v(t,x)$ and therefore may require semi-implicit methods such as the semi-implicit Crank-Nicolson method,
