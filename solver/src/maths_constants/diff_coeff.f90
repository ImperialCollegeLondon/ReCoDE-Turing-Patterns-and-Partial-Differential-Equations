...
integer :: DiffOrder
integer :: sub_diag,sup_diag ! number of sub/super_diagonals of the given matrices
...
!!!! fourth order accurate
    ...
    !! f2 
    D1(2,1) = -1.d0/5.d0; D1(2,2) = -13.d0/12.d0; D1(2,3) = 2.d0; D1(2,4) = -1.d0; D1(2,5) = 1.d0/3.d0; D1(2,6) = -1.d0/20.d0
    !! C
...
!!!! Second Derivative
    ...
    !! f2 
    D2(2,1) = 5.d0/6.d0; D2(2,2) = -5.d0/4.d0; D2(2,3) = -1.d0/3.d0; D2(2,4) = 7.d0/6.d0; D2(2,5) = -1.d0/2.d0; D2(2,6) = 1.d0/12.d0
    !! C
    D2(3,1) = 0.d0; D2(3,2) = -1.d0/12.d0; D2(3,3) = 4.d0/3.d0; D2(3,4) = -5.d0/2.d0; D2(3,5)=4.d0/3.d0; D2(3,6) = -1.d0/12.d0

case(3)

    sub_diag = 4;sup_diag = 4
...
!!!! Second Derivatives
    D2(1,1) = 35.d0/12.d0; D2(1,2) = -26.d0/3.d0; D2(1,3) = 19.d0/2.d0; D2(1,4) = -14.d0/3.d0; D2(1,5) = 11.d0/12.d0
        !! f2 
    D2(2,1) = 5.d0/6.d0; D2(2,2) = -5.d0/4.d0; D2(2,3) = -1.d0/3.d0; D2(2,4) = 7.d0/6.d0; D2(2,5) = -1.d0/2.d0; D2(2,6) = 1.d0/12.d0
        !! C
    D2(3,1) = 0.d0; D2(3,2) = -1.d0/12.d0; D2(3,3) = 4.d0/3.d0; D2(3,4) = -5.d0/2.d0; D2(3,5)=4.d0/3.d0; D2(3,6) = -1.d0/12.d0
