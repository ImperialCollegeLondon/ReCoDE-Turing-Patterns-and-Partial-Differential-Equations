module equations_test
	use type_kinds, only : dp
	use equations_definition_test, only : equation1,equation1_BC_Top,equation1_BC_Bot
...
subroutine build_the_matrix_test(n,ch,chsq,cdom,metric1,metric1sq,metric2)
...
!!! put the matrix in banded form
	...
	return
end subroutine build_the_matrix_test

end module equations_test